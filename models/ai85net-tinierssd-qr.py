...
class TinySSDBase(nn.Module):
    ...
    def __init__(self, **kwargs):
        ...
        # self.fire3_1 = ai8x.FusedMaxPoolConv2dBNReLU(64, 64, 3, padding=1, **kwargs)
        # self.fire4 = ai8x.FusedConv2dBNReLU(64, 64, 3, padding=1, **kwargs)

        # self.fire5 = ai8x.FusedMaxPoolConv2dBNReLU(64, 64, 3, padding=1, **kwargs)
...
def ai85tinierssdqr(pretrained=False, **kwargs):
    """
